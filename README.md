...
2. **Approach**
   ...
   - Technical summary:
     ...
     - Connectors store their randomly assigned effect type and, if the user presses **H**, label it above the line so testers can see which FX bus they’re feeding.
